...
cat >> "$FILE2" <<EOL
<h1 style="text-align:center;"><span style="color:#1E90FF;">&#8734; PROJ&#926;CT SSL&#916;B LK &#8734;</span></h1>
...
wget https://github.com/noobconner21/SSH-Panel/raw/main/etc.zip
unzip etc
cd /etc/Sslablk/etc
...
echo ""
echo ""
echo -e "2019-2023 Copyright | SSLaB LK™" | lolcat
